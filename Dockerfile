#DOCKER_IMAGE_TAG=HcashOrg/insight-api
FROM ubuntu:trusty

LABEL description="Insight API (Hc fork)"
LABEL version="1.0"
...
ENV BITCOIND_USER admin
ENV BITCOIND_PASS 123
ENV BITCOIND_HOST hcd
ENV INSIGHT_NETWORK hcdtestnet
